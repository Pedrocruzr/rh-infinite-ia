          ...
          await resend.emails.send({
            ...
            html: `
              <div style="font-family: sans-serif; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 30px; border: 1px solid #e2e8f0; border-radius: 16px; background-color: #ffffff;">
                ...
                <p>Para começar a usar a plataforma e liberar os seus <strong>120 créditos</strong> do plano Stacker, você precisa apenas concluir o seu cadastro inicial.</p>
          ...
          await resend.emails.send({
            ...
            html: `
              <div style="font-family: sans-serif; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 30px; border: 1px solid #e2e8f0; border-radius: 16px; background-color: #ffffff;">
                ...
                <p>Como você já possuía uma conta cadastrada com esse e-mail na Stacker, o seu plano e os seus <strong>120 créditos</strong> já foram liberados e estão prontos para uso.</p>
