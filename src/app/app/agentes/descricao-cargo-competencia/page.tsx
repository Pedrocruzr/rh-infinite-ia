...
export default function DescricaoCargoCompetenciaPage() {
  ...
  async function startConversation() {
    try {
      ...
      const response = await fetch("/api/agents/descricao-cargo-competencia", {
        method: "POST",
        headers: {
  ...
  return (
    <StandardAgentLayout
      ...
      title="Descrição de Cargo por Competência"
