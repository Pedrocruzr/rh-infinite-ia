...
export default function AnalistaPDIPage() {
  ...
  async function startConversation() {
    try {
      ...
      const response = await fetch("/api/agents/analista-pdi", {
        method: "POST",
        headers: {
  ...
  async function sendAnswer() {
    ...
    const validationError = validateClientAgentInput("analista-pdi", currentField ?? null, answer);
    if (validationError) {
      setMessages((prev) => [
        ...prev,
        {
