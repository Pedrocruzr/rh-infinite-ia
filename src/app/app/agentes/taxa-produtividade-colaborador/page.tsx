...
export default function TaxaProdutividadeColaboradorPage() {
  ...
  async function startConversation() {
    try {
      ...
      const response = await fetch("/api/agents/taxa-produtividade-colaborador", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify({ currentField: "nomeColaborador", session: {} }),
      });
