...
type Message = {
  ...
  role: "assistant" | "user";
  content: string;
  sessionSnapshot?: EntrevistadorSession | null;
};
...
export default function EntrevistadorAutomatizadoPage() {
  const [session, setSession] = useState<EntrevistadorSession | null>(null);
        ...
        <div className="mt-4 rounded-[36px] border border-neutral-200 bg-neutral-50/40 p-5">
          <div className="mx-auto flex h-[calc(100dvh-300px)] min-h-[480px] max-h-[620px] max-w-5xl flex-col">
            ...
            <div className="mt-4 border-t border-neutral-200 pt-4">
              <div className="rounded-[28px] border border-neutral-950 bg-white p-2">
                <div className="flex items-end gap-3">
                  ...
                  <button
                    ...
                    className="h-[52px] rounded-[18px] bg-neutral-950 px-5 text-sm font-medium text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    Enviar
                  </button>
                </div>
