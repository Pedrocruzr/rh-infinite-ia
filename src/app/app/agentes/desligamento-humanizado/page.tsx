...
export default function DesligamentoHumanizadoPage() {
  ...
  async function startConversation() {
    try {
      ...
      const response = await fetch("/api/agents/desligamento-humanizado", {
        method: "POST",
        headers: {
  ...
  async function sendAnswer() {
    ...
    const validationError = validateClientAgentInput("desligamento-humanizado", currentField ?? null, answer);
    if (validationError) {
      setMessages((prev) => [
        ...prev,
        {
