  ...
  return assessment.report_markdown ? (
    <div
      className="
        ...
        [&_thead_th]:border-b [&_thead_th]:border-slate-300 [&_thead_th]:px-4 [&_thead_th]:py-4 [&_thead_th]:text-left [&_thead_th]:text-[18px] [&_thead_th]:font-semibold dark:[&_thead_th]:border-white/10
        [&_tbody_td]:border-b [&_tbody_td]:border-slate-200 [&_tbody_td]:px-4 [&_tbody_td]:py-5 [&_tbody_td]:align-top [&_tbody_td]:text-[18px] [&_tbody_td]:leading-10 dark:[&_tbody_td]:border-white/10
